...
Option Explicit
Public Function CrearNuevoAnoDelAdmin(ByVal IdEmpresa As Long, ByVal Ano As Integer, ByVal Rut As String, ByVal NombreEmpresa As String) As Boolean
   Dim Q1 As String
   Dim Rs As Recordset
...
#End If
   ...
   Call AddLog("CrearNuevoAnoDelAdmin: 1", 1)
   ...
   If gEmprSeparadas Then
      If ExistFile(gDbPath & "\Empresas\" & Ano & "\" & RutMdb) = True Then   'existe archivo nuevo año en empresas separadas
         CrearNuevoAnoDelAdmin = True
         Call AddLog("CrearNuevoAnoDelAdmin: 2", 1)
      ...
      Call AddLog("CrearNuevoAnoDelAdmin: 3", 1)
...
'   End If
   ...
   Call AddLog("CrearNuevoAnoDelAdmin: 4", 1)
...
#If DATACON = 1 Then       'Access
      ...
      Call AddLog("CrearNuevoAnoDelAdmin: 5", 1)
   ...
   Else     'empresas juntas (SQL Server)
      ...
      If Not NuevoAnoVacio Then
         ...
         Else
            ...
            If Rc = vbYes Then
               CrearNuevoAnoDelAdmin = CrearNuevoAnoSQLFromAccess(IdEmpresa, Ano, Rut, NombreEmpresa)
               Exit Function
...
'            If MsgBox1("No existe año anterior para esta empresa en la base SQL Server, debe partir de una empresa vacía." & vbCrLf & vbCrLf & "¿Desea continuar?", vbExclamation + vbYesNo + vbDefaultButton2) <> vbYes Then
   ...
   Call AddLog("CrearNuevoAnoDelAdmin: 6", 1)
...
#End If
   ...
   Set Rs = OpenRs(DbMain, Q1)
      ...
      If Rs.EOF Then
        ...
        Q1 = "INSERT INTO Empresa(Id,Ano,Rut,NombreCorto) VALUES(" & IdEmpresa & "," & Ano & ",'" & Rut & "','" & NombreEmpresa & "')"
        Call ExecSQL(DbMain, Q1)
...
#End If
   ...
   Else 'empresa vacía
      ...
      Call AddLog("CrearNuevoAnoDelAdmin: 6.1", 1)
...
'      Call AddLog("CrearNuevoAnoDelAdmin: 6.2", 1)
...
'      Call AddLog("CrearNuevoAnoDelAdmin: 6.3", 1)
...
#End If
   ...
   Call AddLog("CrearNuevoAnoDelAdmin: FIN ", 1)
...
Public Function CopyDocsFromAccessToSQLServer(ByVal DbAnoAnt As Database, ByVal IdEmpresa As Long, ByVal Ano As Long)
   ...
   Dim FldArray(44) As AdvTbAddNew_t
...
'   Q1 = Q1 & " WHERE (FExported = 0 OR FExported Is NULL) "    'para que siempre pueda volver a importar por si tiene que volver a hacerlo
   ...
   '626850
      'marcamos los que vamos a exportar con -1 los ODF
   Q1 = "UPDATE Documento SET FExported = -1"
'   Q1 = Q1 & " WHERE (FExported = 0 OR FExported Is NULL) "    'para que siempre pueda volver a importar por si tiene que volver a hacerlo
   '616437 ffv odf
   ...
   Q1 = Q1 & " Cuentas.Codigo as CodCtaAfectoOld, Cuentas1.Codigo As CodCtaExentoOld, Cuentas2.Codigo As CodCtaTotalOld, Tratamiento "
...
'      '626850
      FldArray(44).FldName = "Tratamiento"
      FldArray(44).FldValue = vFldDao(RsDao("Tratamiento"))
      FldArray(44).FldIsNum = False
'      'fin 626850
