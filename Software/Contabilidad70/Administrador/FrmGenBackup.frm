...
Begin VB.Form FrmGenBackup 
   ...
   End
End
Attribute VB_Name = "FrmGenBackup"
...
Private Function GenZip(ByVal ZipPath As String) As Long
   ...
   ZipFile = ZipPath & "\DbLPContab" & Format(Now, "yymmdd") & ".zip"
