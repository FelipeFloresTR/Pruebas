...
Txt.Refresh
Txt.Caption = "Proceso de Traspaso... Año " & Ano & " (" & PG.Value & " / " & PG.Max & ")"
Call TrasCapPropioSimplAnual(DBSql, DbAccess, IdEmpresa, Ano)
i = i + 1
PG.Value = i
Txt.Refresh
Txt.Caption = "Proceso de Traspaso... Año " & Ano & " (" & PG.Value & " / " & PG.Max & ")"
...
Txt.Refresh
Txt.Caption = "Proceso de Traspaso... Año " & Ano & " (" & PG.Value & " / " & PG.Max & ")"
Call TrasLogImpreso(DBSql, DbAccess, IdEmpresa, Ano)
i = i + 1
PG.Value = i
Txt.Refresh
Txt.Caption = "Proceso de Traspaso... Año " & Ano & " (" & PG.Value & " / " & PG.Max & ")"
...
'   Set Rs1 = OpenRs(DBSql, Q1)
   ...
   Do While Rs.EOF = False
            ...
            Q1 = "SELECT * "
            Q1 = Q1 & " From Empresas"
            Q1 = Q1 & " WHERE Rut = '" & vFldDao(Rs("Rut")) & "'"
            'Q1 = Q1 & " WHERE Ltrim(Rtrim(NombreCorto)) = '" & LTrim(RTrim((vFldDao(Rs("NombreCorto"))))) & "'"
...
Public Sub ModCtaParamEmpresa(DBSql As ADODB.Connection, IdEmpresa As Long, Ano As Integer)
   Dim Q1 As String
    ...
    Q1 = Q1 & " LEFT JOIN Cuentas  as C ON convert(varchar,C.IdTras) = P.valor AND C.Ano = P.Ano AND C.IdEmpresa = P.IdEmpresa"
...
Public Sub TrasEntidades(DBSql As ADODB.Connection, DbAccess As Database, IdEmpresa As Long, Ano As Integer)
   ...
   Q1 = Q1 & " ,EsDelGiro"
   Q1 = Q1 & " ,FranqTribEnt"
   If VerDBAccess > 726 Then
   Q1 = Q1 & " ,Ret3Porc"
   End If
   If VerDBAccess > 728 Then
    Q1 = Q1 & " ,FDesde3Porc"
    Q1 = Q1 & " ,FHasta3Porc"
   End If
...
Public Sub TrasLogImpreso(DBSql As ADODB.Connection, DbAccess As Database, IdEmpresa As Long, Ano As Integer)
   ...
   Dim CantSql As Long
    ...
    Q1 = Q1 & "IF NOT EXISTS( "
    Q1 = Q1 & "SELECT * FROM INFORMATION_SCHEMA.COLUMNS "
    Q1 = Q1 & "WHERE TABLE_NAME = 'LogImpreso' AND COLUMN_NAME = 'IdTras' "
    Q1 = Q1 & ")BEGIN "
    Q1 = Q1 & "ALTER TABLE LogImpreso ADD IdTras INT NULL; "
    Q1 = Q1 & "END "
   ...
   Do While Rs.EOF = False
        ...
        If Rs1.EOF = True Then
            ...
            Q1 = Q1 & " ," & vFldDao(Rs("Ano"))
            Q1 = Q1 & " ," & vFldDao(Rs("Fecha"))
            Q1 = Q1 & " ," & vFldDao(Rs("CorrInicio"))
            Q1 = Q1 & " ," & vFldDao(Rs("CorrFin"))
            Q1 = Q1 & " ," & vFldDao(Rs("idInforme"))
            Q1 = Q1 & " ," & vFldDao(Rs("Estado"))
            Q1 = Q1 & " ,'" & vFldDao(Rs("Comentario")) & "'"
            Q1 = Q1 & " ," & vFldDao(Rs("IdUsuario"))
            Q1 = Q1 & " ," & vFldDao(Rs("Mes"))
        ...
        Else
            ...
            Q1 = Q1 & " UPDATE dbo.LogImpreso"
            Q1 = Q1 & " SET Fecha = " & vFldDao(Rs("Fecha"))
            Q1 = Q1 & " ,CorrInicio = " & vFldDao(Rs("CorrInicio"))
            Q1 = Q1 & " ,CorrFin = " & vFldDao(Rs("CorrFin"))
            Q1 = Q1 & " ,idInforme = " & vFldDao(Rs("idInforme"))
            Q1 = Q1 & " ,Estado = " & vFldDao(Rs("Estado"))
            Q1 = Q1 & " ,Comentario = '" & vFldDao(Rs("Comentario")) & "'"
            Q1 = Q1 & " ,IdUsuario = " & vFldDao(Rs("IdUsuario"))
            Q1 = Q1 & " ,Mes = " & vFldDao(Rs("Mes"))
...
Public Sub TrasFactorActAnual(DBSql As ADODB.Connection, DbAccess As Database)
   ...
   If CantSql < vFldDao(Rs("Cant")) Then
       ...
       Do While Rs.EOF = False
            ...
            Q1 = Q1 & " AND MesRow = " & vFldDao(Rs("MesRow"))
...
Public Sub TrasCapPropioSimplAnual(DBSql As ADODB.Connection, DbAccess As Database, IdEmpresa As Long, Ano As Integer)
    ...
    If CantSql < vFldDao(Rs("Cant")) Then
       ...
       Do While Rs.EOF = False
            ...
            Else
                ...
                Q1 = Q1 & " , RemIVAUTM = " & str(vFmt(vFldDao(Rs("RemIVAUTM"))))
                Q1 = Q1 & " , RemIVAUTMAnoAnt = " & str(vFmt(vFldDao(Rs("RemIVAUTMAnoAnt")))) 'vFldDao(Rs("RemIVAUTMAnoAnt"))
                Q1 = Q1 & " , SaldoLibroCaja = " & str(vFmt(vFldDao(Rs("SaldoLibroCaja"))))
                Q1 = Q1 & " , CredArt33bis = " & str(vFmt(vFldDao(Rs("CredArt33bis"))))
                Q1 = Q1 & " , CPS_CapitalAportado = " & str(vFmt(vFldDao(Rs("CPS_CapitalAportado"))))
                Q1 = Q1 & " , CPS_BaseImpPrimCat_14DN3 = " & str(vFmt(vFldDao(Rs("CPS_BaseImpPrimCat_14DN3"))))
                Q1 = Q1 & " , CPS_BaseImpPrimCat_14DN8 = " & str(vFmt(vFldDao(Rs("CPS_BaseImpPrimCat_14DN8"))))
                Q1 = Q1 & " , CPS_Participaciones = " & str(vFmt(vFldDao(Rs("CPS_Participaciones"))))
                Q1 = Q1 & " , CPS_Disminuciones = " & str(vFmt(vFldDao(Rs("CPS_Disminuciones"))))
                Q1 = Q1 & " , CPS_GastosRechazados = " & str(vFmt(vFldDao(Rs("CPS_GastosRechazados"))))
                Q1 = Q1 & " , CPS_RetirosDividendos = " & str(vFmt(vFldDao(Rs("CPS_RetirosDividendos"))))
                Q1 = Q1 & " , CPS_CapPropioSimplificado = " & str(vFmt(vFldDao(Rs("CPS_CapPropioSimplificado"))))
                Q1 = Q1 & " , CPS_AumentosCapital = " & str(vFmt(vFldDao(Rs("CPS_AumentosCapital"))))
                Q1 = Q1 & " , CPS_GastosRechazadosNoPagan40 = " & str(vFmt(vFldDao(Rs("CPS_GastosRechazadosNoPagan40"))))
                Q1 = Q1 & " , CPS_INRPropios = " & str(vFmt(vFldDao(Rs("CPS_INRPropios"))))
                Q1 = Q1 & " , CPS_OtrosAjustesAumentos = " & str(vFmt(vFldDao(Rs("CPS_OtrosAjustesAumentos"))))
                Q1 = Q1 & " , CPS_OtrosAjustesDisminuciones = " & str(vFmt(vFldDao(Rs("CPS_OtrosAjustesDisminuciones"))))
                Q1 = Q1 & " , CPS_CapPropioTrib = " & str(vFmt(vFldDao(Rs("CPS_CapPropioTrib"))))
                Q1 = Q1 & " , CPS_CapPropioTribAnoAnt = " & str(vFmt(vFldDao(Rs("CPS_CapPropioTribAnoAnt"))))
                Q1 = Q1 & " , CPS_RepPerdidaArrastre = " & str(vFmt(vFldDao(Rs("CPS_RepPerdidaArrastre"))))
                Q1 = Q1 & " , CPS_CapPropioSimplVarAnual = " & str(vFmt(vFldDao(Rs("CPS_CapPropioSimplVarAnual"))))
                Q1 = Q1 & " , CPS_INRPropiosPerdidas = " & str(vFmt(vFldDao(Rs("CPS_INRPropiosPerdidas"))))
                Q1 = Q1 & " , CPS_UtilidadesPerdida = " & str(vFmt(vFldDao(Rs("CPS_UtilidadesPerdida"))))
                Q1 = Q1 & " , CPS_IngresoDiferido = " & str(vFmt(vFldDao(Rs("CPS_IngresoDiferido"))))
                Q1 = Q1 & " , CPS_CTDImputableIPE = " & str(vFmt(vFldDao(Rs("CPS_CTDImputableIPE"))))
                Q1 = Q1 & " , CPS_IncentivoAhorro = " & str(vFmt(vFldDao(Rs("CPS_IncentivoAhorro"))))
                Q1 = Q1 & " , CPS_IDPCVoluntario = " & str(vFmt(vFldDao(Rs("CPS_IDPCVoluntario"))))
                Q1 = Q1 & " , CPS_CredActFijos = " & str(vFmt(vFldDao(Rs("CPS_CredActFijos"))))
                Q1 = Q1 & " , CPS_CredParticipaciones = " & str(vFmt(vFldDao(Rs("CPS_CredParticipaciones"))))
                Q1 = Q1 & " WHERE idEmpresa = " & IdEmpresa
                Q1 = Q1 & " AND Ano = " & vFldDao(Rs("Ano"))
                Call ExecSQL(DBSql, Q1)
...
Public Sub TrasDocumento(DBSql As ADODB.Connection, DbAccess As Database, IdEmpresa As Long, Ano As Integer)
   ...
   Do While Rs.EOF = False
'
'   If vFldDao(Rs("NumDoc")) = 11639382 Then
'        MsgBox ""
'   End If
            ...
            If Rs1.EOF = True Then
                ...
                Q1 = Q1 & " ,TipoRelEnt"
                Q1 = Q1 & " ,IdSucursal"
                If Not IsNull(Rs("TotPagadoAnoAnt")) Then
                    Q1 = Q1 & " ,TotPagadoAnoAnt"
                End If
                Q1 = Q1 & " ,FImportSuc"
                Q1 = Q1 & " ,Giro"
...
Public Sub TrasActFijoCompsFicha(DBSql As ADODB.Connection, DbAccess As Database, IdEmpresa As Long, Ano As Integer)
   ...
   Do While Rs.EOF = False
            ...
            If Rs1.EOF = True Then
                ...
                Q1 = "SELECT IdActFijo "
                Q1 = Q1 & " From MovActivoFijo"
                Q1 = Q1 & " WHERE IdTras = " & vFldDao(Rs("IdActFijo"))
                Q1 = Q1 & " AND Ano = " & vFldDao(Rs("Ano"))
                Q1 = Q1 & " AND IdEmpresa = " & IdEmpresa
                Set Rs2 = OpenRs(DBSql, Q1)
...
'    Q1 = Q1 & " SET    AFC.IdActFijo = ISNULL(MA.IdActFijo,AFC.IdActFijo),"
    Q1 = Q1 & "  SET   AFC.IdGrupo = ISNULL(AG.IdGrupo,AFC.IdGrupo),"
...
Public Sub TrasActFijoFicha(DBSql As ADODB.Connection, DbAccess As Database, IdEmpresa As Long, Ano As Integer)
   ...
   Do While Rs.EOF = False
            ...
            'Q1 = Q1 & " AND IdActFijo = " & vFldDao(Rs("IdActFijo"))
            Set Rs1 = OpenRs(DBSql, Q1)
...
'                Q1 = Q1 & " ,IdGrupo = " & vFldDao(Rs("IdGrupo"))
                ...
                Q1 = Q1 & " AND Ano = " & vFldDao(Rs("Ano"))
                Q1 = Q1 & " AND IdTras = " & vFldDao(Rs("IdFicha"))
                Q1 = Q1 & " AND IdActFijo = " & vFldDao(Rs1("IdActFijo"))
                Call ExecSQL(DBSql, Q1)
   ...
   Call CloseRs(Rs)
    ...
    Q1 = Q1 & "  SET AF.IdGrupo = AG.IdGrupo,"
