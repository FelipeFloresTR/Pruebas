...
Begin VB.Form FrmConfigCtasLibCompras 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Configuración de Cuentas Libro de Compras"
   ClientHeight    =   7905
   ClientLeft      =   45
   ClientTop       =   390
   ClientWidth     =   13995
   ...
   Begin VB.CommandButton Bt_DelAll 
      ...
      Height          =   800
      Left            =   12600
      Picture         =   "FrmConfigCtasLibCompras.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   10
   ...
   Begin VB.CommandButton Bt_Import 
      ...
      Height          =   800
      Left            =   12600
      Picture         =   "FrmConfigCtasLibCompras.frx":0619
      Style           =   1  'Graphical
      TabIndex        =   11
   ...
   Begin TabDlg.SSTab Tab_Config 
      ...
      TabPicture(0)   =   "FrmConfigCtasLibCompras.frx":0C8C
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "Label2"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).Control(1)=   "Cb_LLenarPropIVA"
      Tab(0).Control(1).Enabled=   0   'False
      Tab(0).Control(2)=   "Bt_LllenarPropIVA"
      Tab(0).Control(2).Enabled=   0   'False
      Tab(0).Control(3)=   "GridAfecto"
      Tab(0).Control(3).Enabled=   0   'False
      Tab(0).ControlCount=   4
      TabCaption(1)   =   "Cuentas Exento"
      TabPicture(1)   =   "FrmConfigCtasLibCompras.frx":0CA8
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "GridExento"
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "Cuentas Total"
      TabPicture(2)   =   "FrmConfigCtasLibCompras.frx":0CC4
      ...
      Begin FlexEdGrid3.FEd3Grid GridAfecto 
         ...
         Locked          =   0   'False
      End
      Begin VB.CommandButton Bt_LllenarPropIVA 
         Caption         =   "LLenar todo"
         Height          =   315
         Left            =   2160
         TabIndex        =   6
         ...
         Width           =   1095
      End
      Begin VB.ComboBox Cb_LLenarPropIVA 
         Height          =   315
         Left            =   1200
   ...
   Begin VB.PictureBox Picture1 
      ...
      Height          =   630
      Left            =   180
      Picture         =   "FrmConfigCtasLibCompras.frx":0CE0
      ScaleHeight     =   630
      ScaleWidth      =   690
      TabIndex        =   18
      Top             =   300
   ...
   Begin VB.CommandButton Bt_Cuentas 
      ...
      Height          =   375
      Left            =   12540
      Picture         =   "FrmConfigCtasLibCompras.frx":135B
      Style           =   1  'Graphical
      TabIndex        =   17
   ...
   Begin VB.CommandButton Bt_SelCuenta 
      ...
      Height          =   795
      Left            =   12600
      Picture         =   "FrmConfigCtasLibCompras.frx":171C
      Style           =   1  'Graphical
      TabIndex        =   7
      Top             =   1200
      Width           =   1155
   ...
   Begin VB.CommandButton Bt_CopyExcel 
      ...
      Height          =   795
      Left            =   12600
      Picture         =   "FrmConfigCtasLibCompras.frx":1CB7
      Style           =   1  'Graphical
      TabIndex        =   8
   ...
   Begin VB.CommandButton Bt_Del 
      ...
      Height          =   800
      Left            =   12600
      Picture         =   "FrmConfigCtasLibCompras.frx":226C
      Style           =   1  'Graphical
      TabIndex        =   9
      ToolTipText     =   "Eliminar cuenta seleccionada"
      Top             =   3000
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Bt_Search 
         ...
         Height          =   375
         Left            =   10800
         Picture         =   "FrmConfigCtasLibCompras.frx":28CE
         Style           =   1  'Graphical
         TabIndex        =   4
   ...
   End
End
Attribute VB_Name = "FrmConfigCtasLibCompras"
...
Private Sub SetUpGrid(Grid As FEd3Grid, Optional ByVal ConPropIVA As Boolean = True)
   Dim i As Integer
   ...
   Grid.ColWidth(C_PROPIVA) = 560
   
   If Not ConPropIVA Then
      Grid.ColWidth(C_NOMBRE) = Grid.ColWidth(C_NOMBRE) + Grid.ColWidth(C_PROPIVA)
   ...
   If Grid.ColWidth(C_PROPIVA) > 0 Then
      Grid.TextMatrix(0, C_PROPIVA) = "Pr.IVA"
   End If
...
Private Function DelAllGrid(Grid As FEd3Grid)
   ...
   For i = Grid.FixedRows To Grid.rows - 1
      ...
      For j = C_IDPROPIVA To C_CODCCOSTO
         Grid.TextMatrix(i, j) = ""
      Next j
...
Private Sub Bt_FmtImport_Click()
   ...
   Call Frm.FViewConfigCtasLibCompras
   Set Frm = Nothing
...
Private Sub Bt_Import_Click()
   ...
   Call ImpCtasLibCompras(FName)
      
End Sub

Private Sub Bt_LllenarPropIVA_Click()
   Dim Row As Integer

   If MsgBox1("¿Está seguro que desea cambiar la definición de Proporcionalidad de IVA para TODAS las entidades, por aquella que está seleccionada aquí?", vbQuestion + vbYesNoCancel) <> vbYes Then
      Exit Sub
   End If
   ...
   For Row = GridAfecto.FixedRows To GridAfecto.rows - 1
      ...
      If Val(GridAfecto.TextMatrix(Row, C_IDENTIDAD)) > 0 Then
         GridAfecto.TextMatrix(Row, C_IDPROPIVA) = CbItemData(Cb_LLenarPropIVA)
         GridAfecto.TextMatrix(Row, C_PROPIVA) = Left(gStrPropIVA(Val(GridAfecto.TextMatrix(Row, C_IDPROPIVA))), 1)
...
Private Sub Form_Load()
   ...
   If LoadCodCuentasDefLibros(LIB_COMPRAS, lCodCtaAfecto, lCodCtaExento, lCodCtaTotal) Then
   
      Call FillCuentasUtilizadas(LIB_COMPRAS, LIBCOMPRAS_AFECTO, "CodCtaAfecto", "CodCCostoAfecto", "CodAreaNegAfecto", lCodCtaAfecto)
      Call FillCuentasUtilizadas(LIB_COMPRAS, LIBCOMPRAS_EXENTO, "CodCtaExento", "CodCCostoExento", "CodAreaNegExento", lCodCtaExento)
      Call FillCuentasUtilizadas(LIB_COMPRAS, LIBCOMPRAS_TOTAL, "CodCtaTotal", "CodCCostoTotal", "CodAreaNegTotal", lCodCtaTotal)
      ...
      Set Rs = OpenRs(DbMain, "SELECT Codigo FROM ParamEmpresa WHERE Tipo = 'CONFCTACMP'  AND IdEmpresa = " & gEmpresa.id & " AND Ano = " & gEmpresa.Ano)
      If Rs.EOF Then
         Call FillCuentasUtilizadasAnoAnt(LIB_COMPRAS, LIBCOMPRAS_AFECTO, "CodCtaAfecto", "CodCCostoAfecto", "CodAreaNegAfecto", lCodCtaAfecto)
         Call FillCuentasUtilizadasAnoAnt(LIB_COMPRAS, LIBCOMPRAS_EXENTO, "CodCtaExento", "CodCCostoExento", "CodAreaNegExento", lCodCtaExento)
         Call FillCuentasUtilizadasAnoAnt(LIB_COMPRAS, LIBCOMPRAS_TOTAL, "CodCtaTotal", "CodCCostoTotal", "CodAreaNegTotal", lCodCtaTotal)
         
         Q1 = "INSERT INTO ParamEmpresa (Tipo, Codigo, Valor, IdEmpresa, Ano) VALUES( 'CONFCTACMP', 0, 'ConfigCtasImpLibCompSIIAnoAnt', " & gEmpresa.id & "," & gEmpresa.Ano & ")"
   ...
   For i = 0 To UBound(gStrPropIVA)
      Call CbAddItem(Cb_LLenarPropIVA, gStrPropIVA(i), i)
   Next i
   Cb_LLenarPropIVA.ListIndex = 0   'vacío
...
Private Sub LoadAll()
   ...
   Q1 = "SELECT IdEntidad, Entidades.Rut, Entidades.NotValidRut, Entidades.Codigo as CodEnt, Entidades.Nombre as NombEnt, Entidades.PropIVA, "
   ...
   QWh = " WHERE Entidades.Estado = " & EE_ACTIVO & " AND Clasif" & ENT_PROVEEDOR & " <> 0 "
   QWh = QWh & " AND Entidades.IdEmpresa = " & gEmpresa.id & " AND (Cuentas.Ano IS NULL OR Cuentas.Ano = " & gEmpresa.Ano & ")"
   Q2 = ""
   ...
   QCta = " Entidades.CodCtaAfecto = Cuentas.Codigo  "
   TipoVal = "Afecto"
   Q2 = " LEFT JOIN CentroCosto ON Entidades.CodCCosto" & TipoVal & " = CentroCosto.Codigo  "
   Q2 = Q2 & " AND CentroCosto.IdEmpresa = Entidades.IdEmpresa  ) "
   Q2 = Q2 & " LEFT JOIN AreaNegocio ON Entidades.CodAreaNeg" & TipoVal & " = AreaNegocio.Codigo "
   Q2 = Q2 & " AND AreaNegocio.IdEmpresa = Entidades.IdEmpresa  "
   Call LoadGrid(GridAfecto, Q1 & QCta & OnEmp & Q2 & QWh & QSort, True)
   
   QCta = " Entidades.CodCtaExento = Cuentas.Codigo "
   TipoVal = "Exento"
   Q2 = " LEFT JOIN CentroCosto ON Entidades.CodCCosto" & TipoVal & " = CentroCosto.Codigo "
   Q2 = Q2 & " AND CentroCosto.IdEmpresa = Entidades.IdEmpresa  ) "
   Q2 = Q2 & " LEFT JOIN AreaNegocio ON Entidades.CodAreaNeg" & TipoVal & " = AreaNegocio.Codigo "
   Q2 = Q2 & " AND AreaNegocio.IdEmpresa = Entidades.IdEmpresa  "
   Call LoadGrid(GridExento, Q1 & QCta & OnEmp & Q2 & QWh & QSort, False)
   
   QCta = " Entidades.CodCtaTotal = Cuentas.Codigo  "
   ...
   Q2 = Q2 & " LEFT JOIN AreaNegocio ON Entidades.CodAreaNeg" & TipoVal & " = AreaNegocio.Codigo "
   Q2 = Q2 & " AND AreaNegocio.IdEmpresa = Entidades.IdEmpresa  "
   Call LoadGrid(GridTotal, Q1 & QCta & OnEmp & Q2 & QWh & QSort, False)
   
End Sub
Private Sub LoadGrid(Grid As FEd3Grid, ByVal Q1 As String, ByVal Msg As Boolean)
   Dim i As Integer
   Dim Rs As Recordset
   Dim ConPropIVA As Boolean
   
   If Grid.ColWidth(C_PROPIVA) Then
      ConPropIVA = True
   End If
   ...
   Do While Not Rs.EOF
      ...
      If FGrChkMaxSize(Grid, Msg) = True Then
         If Msg Then
            MsgBox1 "Tiene más de " & Grid.rows & " entidades. Elimine o marque como 'No Activas' aquellas que ya no utiliza.", vbInformation
         End If
         Exit Do
      End If
      ...
      If ConPropIVA Then
         ...
         Grid.TextMatrix(i, C_PROPIVA) = Left(gStrPropIVA(Val(Grid.TextMatrix(i, C_IDPROPIVA))), 1)
      End If
...
Private Sub SaveAll()
   ...
   Call SaveGrid(GridAfecto, "CodCtaAfecto", "Afecto")
   Call SaveGrid(GridExento, "CodCtaExento", "Exento")
   Call SaveGrid(GridTotal, "CodCtaTotal", "Total")
...
Private Sub SaveGrid(Grid As FEd3Grid, ByVal CodCtaFldName As String, ByVal TipoVal As String)
   ...
   For i = Grid.FixedRows To Grid.rows - 1
      ...
      If Grid.TextMatrix(i, C_UPD) = FGR_U Then
         ...
         End If
         Q1 = Q1 & ", CodCCosto" & TipoVal & " = '" & ParaSQL(Grid.TextMatrix(i, C_CODCCOSTO)) & "'"
         Q1 = Q1 & ", CodAreaNeg" & TipoVal & " = '" & ParaSQL(Grid.TextMatrix(i, C_CODAREANEG)) & "'"
...
End Sub
Private Function ImpCtasLibCompras(ByVal FName As String) As Integer
   ...
   Dim IdPropIVA As Integer, PropIVA As String
   ...
   If gDbType = SQL_ACCESS Then
    If LineCount(FName, MaxReg) < 0 Then
       MsgBox1 "El archivo tiene más registros de los que soporta el sistema para la lista de cuentas del libro de compras (máx. " & MaxReg & " documentos)." & vbCrLf & vbCrLf & "No es posible realizar el proceso de importación.", vbExclamation
       Exit Function
    End If
   End If
   ...
   Do Until EOF(Fd)
      ...
      If IdEntidad = 0 Then
         If Not AddEntidad(RutProv, RazonSocialProv, IdEntidad, ENT_PROVEEDOR) Then
      ...
      'Prop. IVA
      PropIVA = Trim(NextField2(Buf, p, Sep))
      ValidPropIVA = ",P,T,N,"
      
      IdPropIVA = 0
      If PropIVA <> "" Then
      
         If InStr(ValidPropIVA, "," & PropIVA & ",") <= 0 Then
            Call AddLogImp(FNameLogImp, FName, l, "Tipo de Proporcionalidad de IVA inválido.")
            ConfigErr = True
            GoTo NextRec
         End If
      
         For i = 0 To UBound(gStrPropIVA)
            If PropIVA = Left(gStrPropIVA(i), 1) Then
               IdPropIVA = i
            End If
         Next i
      ...
      Q1 = Q1 & ", CodCtaAfecto = '" & AuxCodCtaAfecto & "'"
      Q1 = Q1 & ", CodCtaExento = '" & AuxCodCtaExento & "'"
      Q1 = Q1 & ", CodCtaTotal = '" & AuxCodCtaTotal & "'"
