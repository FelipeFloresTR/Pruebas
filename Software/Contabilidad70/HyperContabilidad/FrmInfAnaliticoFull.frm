...
Begin VB.Form FrmInfAnaliticoFull 
   ...
   ClientTop       =   330
   ClientWidth     =   13860
   Icon            =   "FrmInfAnaliticoFull.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   8700
   ScaleWidth      =   13860
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Bt_VerComp 
         ...
         Height          =   375
         Left            =   120
         Picture         =   "FrmInfAnaliticoFull.frx":000C
         Style           =   1  'Graphical
         TabIndex        =   18
      ...
      Begin VB.CommandButton Bt_VerDoc 
         ...
         Height          =   375
         Left            =   540
         Picture         =   "FrmInfAnaliticoFull.frx":0485
         Style           =   1  'Graphical
         TabIndex        =   19
      ...
      Begin VB.CommandButton Bt_Print 
         ...
         Height          =   375
         Left            =   1500
         Picture         =   "FrmInfAnaliticoFull.frx":08F9
         Style           =   1  'Graphical
         TabIndex        =   21
      ...
      Begin VB.CommandButton Bt_Preview 
         ...
         Height          =   375
         Left            =   1080
         Picture         =   "FrmInfAnaliticoFull.frx":0DB3
         Style           =   1  'Graphical
         TabIndex        =   20
      ...
      Begin VB.CommandButton Bt_CopyExcel 
         ...
         Height          =   375
         Left            =   1920
         Picture         =   "FrmInfAnaliticoFull.frx":125A
         Style           =   1  'Graphical
         TabIndex        =   22
      ...
      Begin VB.CommandButton Bt_Calendar 
         ...
         Height          =   375
         Left            =   3840
         Picture         =   "FrmInfAnaliticoFull.frx":169F
         Style           =   1  'Graphical
         TabIndex        =   26
      ...
      Begin VB.CommandButton Bt_ConvMoneda 
         ...
         Height          =   375
         Left            =   3000
         Picture         =   "FrmInfAnaliticoFull.frx":1AC8
         Style           =   1  'Graphical
         TabIndex        =   24
      ...
      Begin VB.CommandButton Bt_Calc 
         ...
         Height          =   375
         Left            =   3420
         Picture         =   "FrmInfAnaliticoFull.frx":1E66
         Style           =   1  'Graphical
         TabIndex        =   25
      ...
      Begin VB.CommandButton Bt_Sum 
         ...
         Height          =   375
         Left            =   2460
         Picture         =   "FrmInfAnaliticoFull.frx":21C7
         Style           =   1  'Graphical
         TabIndex        =   23
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Bt_SelCuenta 
         Height          =   315
         Left            =   9300
         Picture         =   "FrmInfAnaliticoFull.frx":226B
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      Begin VB.CommandButton Bt_FechaComp 
         Height          =   315
         Left            =   2760
         Picture         =   "FrmInfAnaliticoFull.frx":2660
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   600
         Width           =   225
      ...
      Begin VB.CommandButton Bt_Search 
         ...
         Height          =   675
         Left            =   10500
         Picture         =   "FrmInfAnaliticoFull.frx":296A
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   180
         Width           =   1095
      ...
      Begin VB.CommandButton Bt_Fecha 
         Height          =   315
         Left            =   2760
         Picture         =   "FrmInfAnaliticoFull.frx":2DA8
         Style           =   1  'Graphical
         TabIndex        =   0
         Top             =   180
         Width           =   225
   ...
   End
End
Attribute VB_Name = "FrmInfAnaliticoFull"
...
'      Set RsSaldos = OpenRs(DbMain, "SELECT * FROM Cuentas WHERE 1=0", , dbOpenSnapshot)
   ...
   If TipoInforme = TI_TODOS Or TipoInforme = TI_SOLODOCS_SINCOMP Then
      ...
      Q1 = Q1 & "  iif(Documento.SaldoDoc > 0 AND Documento.Tratamiento = 1 , Documento.SaldoDoc, Sum(MovComprobante.Debe)) As Debe, "
      Q1 = Q1 & "  iif(Documento.SaldoDoc > 0 AND Documento.Tratamiento = 2 , Documento.SaldoDoc, Sum(MovComprobante.Haber)) As Haber "
      Q1 = Q1 & "  , Documento.SaldoDoc "
...
'      End If
     ...
     ' Q1 = Q1 & " AND MovComprobante.idcuenta >0 " '2748525 - 2751484 OTROS DOCU
      ...
      Q1 = Q1 & "  Documento.TipoDoc, Documento.IdEntidad, Entidades.Nombre, Entidades.RUT, " & SqlInt("Entidades.NotValidRut") & ", "
      Q1 = Q1 & "  Documento.FEmisionOri, Documento.FVenc, Documento.Total, Documento.Descrip, "
      Q1 = Q1 & "  Documento.IdCtaBanco, Cuentas.Codigo, Cuentas.Descripcion, Documento.SaldoDoc, Documento.IdDoc " & DetComp2
...
'   End If
   'Q1 = Replace(Replace(Replace(Replace(Replace(Replace(Replace(Q1, " Comprobante ", " ComprobanteFull "), " Comprobante.", " ComprobanteFull."), "MovComprobante", "MovComprobanteFull"), " Documento ", " DocumentoFull "), "Documento.", "DocumentoFull."), "(Documento", "(DocumentoFull"), "FullFull", "Full")
