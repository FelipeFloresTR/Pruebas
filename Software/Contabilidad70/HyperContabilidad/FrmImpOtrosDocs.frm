VERSION 5.00
Begin VB.Form FrmImpOtrosDocs 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Importar Otros Documentos desde Archivo de Texto"
   ClientHeight    =   3885
   ClientLeft      =   45
   ClientTop       =   360
   ClientWidth     =   10350
   ...
   Begin VB.PictureBox Picture1 
      ...
      Height          =   615
      Left            =   540
      Picture         =   "FrmImpOtrosDocs.frx":0000
      ScaleHeight     =   615
      ScaleWidth      =   555
      TabIndex        =   6
      Top             =   600
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Bt_Browse 
         Height          =   495
         Left            =   7800
         Picture         =   "FrmImpOtrosDocs.frx":058D
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   360
         Width           =   1215
   ...
   End
End
Attribute VB_Name = "FrmImpOtrosDocs"
...
Private Sub Bt_Import_Click()
   ...
   Call ImportOtrosDocs(Me, lFName)
