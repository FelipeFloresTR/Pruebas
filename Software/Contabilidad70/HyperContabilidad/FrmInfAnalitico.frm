...
Begin VB.Form FrmInfAnalitico 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Bt_VerComp 
         ...
         Height          =   375
         Left            =   120
         Picture         =   "FrmInfAnalitico.frx":000C
         Style           =   1  'Graphical
         TabIndex        =   18
      ...
      Begin VB.CommandButton Bt_VerDoc 
         ...
         Height          =   375
         Left            =   540
         Picture         =   "FrmInfAnalitico.frx":0485
         Style           =   1  'Graphical
         TabIndex        =   19
      ...
      Begin VB.CommandButton Bt_Print 
         ...
         Height          =   375
         Left            =   1500
         Picture         =   "FrmInfAnalitico.frx":08F9
         Style           =   1  'Graphical
         TabIndex        =   21
      ...
      Begin VB.CommandButton Bt_Preview 
         ...
         Height          =   375
         Left            =   1080
         Picture         =   "FrmInfAnalitico.frx":0DB3
         Style           =   1  'Graphical
         TabIndex        =   20
      ...
      Begin VB.CommandButton Bt_CopyExcel 
         ...
         Height          =   375
         Left            =   1920
         Picture         =   "FrmInfAnalitico.frx":125A
         Style           =   1  'Graphical
         TabIndex        =   22
      ...
      Begin VB.CommandButton Bt_Calendar 
         ...
         Height          =   375
         Left            =   3840
         Picture         =   "FrmInfAnalitico.frx":169F
         Style           =   1  'Graphical
         TabIndex        =   26
      ...
      Begin VB.CommandButton Bt_ConvMoneda 
         ...
         Height          =   375
         Left            =   3000
         Picture         =   "FrmInfAnalitico.frx":1AC8
         Style           =   1  'Graphical
         TabIndex        =   24
      ...
      Begin VB.CommandButton Bt_Calc 
         ...
         Height          =   375
         Left            =   3420
         Picture         =   "FrmInfAnalitico.frx":1E66
         Style           =   1  'Graphical
         TabIndex        =   25
      ...
      Begin VB.CommandButton Bt_Sum 
         ...
         Height          =   375
         Left            =   2460
         Picture         =   "FrmInfAnalitico.frx":21C7
         Style           =   1  'Graphical
         TabIndex        =   23
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Bt_SelCuenta 
         Height          =   315
         Left            =   9300
         Picture         =   "FrmInfAnalitico.frx":226B
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      Begin VB.CommandButton Bt_FechaComp 
         Height          =   315
         Left            =   2760
         Picture         =   "FrmInfAnalitico.frx":2660
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   600
         Width           =   225
      ...
      Begin VB.CommandButton Bt_Search 
         ...
         Height          =   675
         Left            =   11640
         Picture         =   "FrmInfAnalitico.frx":296A
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   180
         Width           =   1095
      ...
      Begin VB.CommandButton Bt_Fecha 
         Height          =   315
         Left            =   2760
         Picture         =   "FrmInfAnalitico.frx":2DA8
         Style           =   1  'Graphical
         TabIndex        =   0
         Top             =   180
         Width           =   225
   ...
   End
End
Attribute VB_Name = "FrmInfAnalitico"
...
Private Function LoadAll()
   ...
   If lViewOtrosDocs Then
      CondOtrosDocs = " NOT "
   Else
      CondDocOtrosEnAnalitico = " OR (Documento.TipoLib IN (" & LIB_OTROS & "," & LIB_REMU & ") AND Documento.DocOtrosEnAnalitico <> 0)"
   End If
   
   'vemos si hay año anterior
   
   If Ch_SaldoApertura And Not ExistFile(gDbPath & "\Empresas\" & gEmpresa.Ano - 1 & "\" & gEmpresa.Rut & ".mdb") And Not gEmpresa.TieneAnoAnt Then
...
'      Set RsSaldos = OpenRs(DbMain, "SELECT * FROM Cuentas WHERE 1=0", , dbOpenSnapshot)
   ...
   If TipoInforme = TI_TODOS Or TipoInforme = TI_SOLODOCS_SINCOMP Then
      ...
      Q1 = Q1 & "  Sum(MovDocumento.Debe) As Debe, Sum(MovDocumento.Haber) As Haber, Documento.SaldoDoc, '' as Glosa "
      ...
      'Q1 = Q1 & "  OR (Documento.Estado IN (" & ED_CENTRALIZADO & "," & ED_PAGADO & ") AND Documento.IdCompCent = 0 AND YEAR(Documento.FEmisionOri) = " & gEmpresa.Ano & " ))"
      Q1 = Q1 & Wh & WhDoc
   ...
   If TipoInforme = TI_TODOS Or TipoInforme = TI_SOLODOCS_CONCOMP Then
      ...
      Q1 = Q1 & "  Sum(MovComprobante.Debe) As Debe, Sum(MovComprobante.Haber) As Haber, Documento.SaldoDoc, MovComprobante.Glosa "
...
'      End If
     ...
     ' Q1 = Q1 & " AND MovComprobante.idcuenta >0 " '2748525 - 2751484 OTROS DOCU
      ...
      Q1 = Q1 & "  Documento.TipoDoc, Documento.IdEntidad, Entidades.Nombre, Entidades.RUT, " & SqlInt("Entidades.NotValidRut") & ", "
      Q1 = Q1 & "  Documento.FEmisionOri, Documento.FVenc, Documento.Total, Documento.Descrip, "
      Q1 = Q1 & "  MovComprobante.IdCuenta, Cuentas.Codigo, Cuentas.Descripcion, Documento.SaldoDoc, MovComprobante.Glosa " & DetComp2
   
   
       '2748525 - 2751484-2768450
       
'      Q1 = Q1 & " UNION "
'      Q1 = Q1 & " SELECT distinct documento.iddoc,  Documento.NumDoc, Documento.TipoLib, Documento.TotPagadoAnoAnt,   Documento.TipoDoc,   Documento.IdEntidad,   Entidades.Nombre, Entidades.RUT, Entidades.NotValidRut AS NotValidRut ,   Documento.FEmisionOri, Documento.FVenc, "
'      Q1 = Q1 & " Documento.Total, Documento.Descrip,   MovComprobante.IdCuenta, Cuentas.Codigo, Cuentas.Descripcion " & DetComp1 & ","
'      Q1 = Q1 & " IIF(MovComprobante.Debe>0,DOCUMENTO.TOTAL,0) As Debe, IIF(MovComprobante.Haber >0,TOTAL,0) As Haber, Documento.SaldoDoc  "
'      Q1 = Q1 & " FROM  (((MovComprobante INNER JOIN Documento ON MovComprobante.IdDoc <> Documento.IdDoc  )  INNER JOIN Comprobante ON MovComprobante.IdComp = Comprobante.IdComp  )  LEFT JOIN Entidades ON Documento.IdEntidad = Entidades.IdEntidad  )  LEFT JOIN Cuentas ON "
'      Q1 = Q1 & " MovComprobante.IdCuenta = Cuentas.IdCuenta where  movcomprobante.Glosa = 'Apertura' AND idctabanco = MovComprobante.idcuenta AND OldIdDoc > 0 "
'
      'fin 2748525 - 2751484-2768450
...
'   Else  'por cuenta
'      Q1 = Q1 & " ORDER BY Cuentas.Codigo, Documento.FEmisionOri, Entidades.Rut, Documento.TipoLib, Documento.TipoDoc, Documento.NumDoc "
'   End If
...
'      Call ExecSQL(DbMain, Q1)
   ...
   If lPorEntidad Then
      Q1 = Q1 & " ORDER BY Nombre, Rut, FEmisionOri, TipoLib, TipoDoc, NumDoc "
   Else  'por cuenta
      Q1 = Q1 & " ORDER BY Codigo, FEmisionOri, Rut, TipoLib, TipoDoc, NumDoc "
   End If
...
'    If vFld(Rs("IdDoc")) = 3047 Then
'      MsgBox ""
'     End If
     
'         If vFld(Rs("NumDoc")) = "1903" Then
'      MsgBox ""
'     End If
...
'            If Ch_SaldosVig <> 0 Then
'
'              If vFmt(Grid.TextMatrix(i, C_IDDOC)) <> 0 And vFmt(Grid.TextMatrix(i, C_SALDO)) = 0 Then
'
'               Debe = Debe - Grid.TextMatrix(i, C_DEBE)
'               Haber = Haber - Grid.TextMatrix(i, C_HABER)
'
'                'SF 14766133 descomentar en caso de corregir problematica presentada en caso sf
...
'         End If
         ...
         If Grid.RowHeight(i) > 0 Then
            ...
            '643438 se crea para eliminar los con saldo 0 si selecciona con saldo vigente
            'para volver atras comentar las filas hasta el *fin 643438
            If Not lPorEntidad Then
                If (Grid.TextMatrix(i, C_DOC) <> "TOTAL" And Grid.TextMatrix(i, C_IDENTIDAD) = "") And vFmt(Grid.TextMatrix(i, C_SALDO)) = 0 Then     'FCA 25/7/2017
                   Grid.RowHeight(i) = 0
                End If
            End If
            'fin 643438
